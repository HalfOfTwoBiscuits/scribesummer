...
class Subscription(db.Model, TimestampMixin):
    ...
    @hybrid_method
    def next_renewal(self, duration: DurationEnum) -> datetime:
        ...
        while renewal < now:
            ...
            match (duration.value):
                case DurationEnum.WEEK: renewal += relativedelta(weeks=1)
                case DurationEnum.YEAR: renewal += relativedelta(years=1)
