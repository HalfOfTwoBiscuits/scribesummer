export class SearchManager {
    // Class that shows and hides search results based on the given criteria.
    // Currently it filters based on a category dropdown, since it was pasted
    // in from a previous project.
    // It will be amended to use an input field instead.

    constructor () {
        this.categoryElem = document.getElementById("searchCategorySelect");
        this.resultAreaElem = document.getElementById("matchingSearchResults");
        this.resultListElem = document.getElementById("resultList");
